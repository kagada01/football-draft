...
d_player_1 = DefPlayer.create!(position: "CB", sacks: 10, interceptions: 5, tackles: 90, fumble_recs: 2, my_team_id: team_1.id)
d_player_2 = DefPlayer.create!(position: "DB", sacks: 5, interceptions: 4, tackles: 100, fumble_recs: 1, my_team_id: team_2.id)
d_player_3 = DefPlayer.create!(position: "DL", sacks: 14, interceptions: 9, tackles: 110, fumble_recs: 4, my_team_id: team_1.id)

o_player_1 = OffPlayer.create!(position: "WR", tds: 9, rush_yds: 100, rec: 80, carries: 2, pass_yds: 0, interceptions: 0, fumbles: 2, my_team_id: team_1.id)
o_player_2 = OffPlayer.create!(position: "QB", tds: 30, rush_yds: 300, rec: 0, carries: 40, pass_yds: 3000, interceptions: 20, fumbles: 1, my_team_id: team_2.id)
o_player_3 = OffPlayer.create!(position: "RB", tds: 20, rush_yds: 2000, rec: 60, carries: 2, pass_yds: 0, interceptions: 0, fumbles: 10, my_team_id: team_1.id)
